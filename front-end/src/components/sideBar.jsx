            ...
            <div className="relative px-6 pb-6">
              <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
                <div className="relative">
                  <div className="w-24 h-24 rounded-full p-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
                    <img
              ...
              <div className="pt-14 text-center">
                <Link to={`profile/${user.id}`}>
                  <h1 className={`font-semibold text-lg mb-1 ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>
                    {user.fullname}
                  </h1>
                </Link>
