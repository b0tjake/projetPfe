...
try {
  ...
  return (
    <div className="flex justify-center text-black items-center min-h-screen bg-gray-100 py-6">
      <div className="flex w-full card items-stretch max-w-4xl p-2 bg-white rounded-2xl shadow-lg">
        {/* Left Side */}
        <div className="w-full md:w-1/2 flex flex-col px-5 py-4">
          <h1 className="text-3xl font-bold connection text-center text-gray-800">Join Jouala</h1>
          <p className="text-gray-500 text-center text-[16px] py-1">join Jouala community now.</p>

          <h3 className="text-2xl font-semibold sign text-gray-700 mt-2">Sign Up</h3>

          <form className="mt-4 flex-1 flex flex-col">
            <div className="flex-1 space-y-3">
              ...
              <div className="relative">
                ...
                >
                  <div className={`w-full h-24 border-2 border-dashed rounded-lg flex flex-col items-center justify-center transition-all ${
                    ...
                    {previewImage ? (
                      ...
                      <>
                        <div className="bg-[#00b69a] bg-opacity-10 rounded-full p-2 mb-1">
                          <FaUser className="text-[#00b69a] text-lg" />
                        </div>
