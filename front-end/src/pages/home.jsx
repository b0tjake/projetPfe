...
export default function Home() {
  ...
  const handleSavePost = async (postId) => {
    ...
    try {
      const isSaved = posts.find(p => p._id === postId)?.savedBy?.includes(userId);
            ...
            posts.map((post) => (
              ...
              >
                ...
                <div className={`px-2 py-1 flex items-center justify-between ${
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-1 ${post.savedBy?.includes(userId) ? "fill-blue-600" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
